...
export default class Item {
  ...
  public setFlags(flags: uint32) {
    ...
    this.blockPathfinder = (flags & ServerItemFlag.BlockPathfinder) === ServerItemFlag.BlockPathfinder;
    ...
    this.allowDistanceRead = (flags & ServerItemFlag.AllowDistanceRead) === ServerItemFlag.AllowDistanceRead;
